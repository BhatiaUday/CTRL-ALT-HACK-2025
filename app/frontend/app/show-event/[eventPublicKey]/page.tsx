                        ...
                        {tickets.map((ticket, index) => (
                            <li key={index} className="mt-4 p-4 bg-white rounded-md shadow-sm">
                                ...
                                <p className="mb-2 flex items-center justify-center">
                                    <b>Original Buyer's Public Key</b>:{" "}
                                    <span
                                ...
                                {ticket.account.nftMint && (
                                    <p className="mb-2 flex items-center justify-center">
                                        <b>Current Owner's Public Key</b>:{" "}
...
const CurrentOwnerDisplay: React.FC<{ mintAddress: PublicKey, getCurrentOwner: (mint: PublicKey) => Promise<PublicKey | null> }> = ({ mintAddress, getCurrentOwner }) => {
    ...
    return (
        <span
            className="truncate bg-green-200 p-1 rounded cursor-pointer"
